...
if task == "response-pull-request":
    ...
    comment_on_issue(repository, issue, f"""Response created by claude:
---

{comment}

---
This comment was generated by claude, an AI assistant. Read how this is done in the [git-bob](https://github.com/haesleinhuepf/git-bob) documentation.
""")
