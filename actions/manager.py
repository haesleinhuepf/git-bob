...
if task == "response-pull-request":
    ...
    remark = "This comment was generated by git-bob, an AI assistant. Read how this is done in the [git-bob](https://github.com/haesleinhuepf/git-bob) documentation."
