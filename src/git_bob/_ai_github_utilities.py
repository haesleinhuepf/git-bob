...
def setup_ai_remark():
    ...
    if run_id is not None:
        link = f""", <a href=f"https://github.com/haesleinhuepf/git-bob/actions/runs/{run_id}" target="_blank">Run details</a>"""
    else:
        link = ""
    return f"<sup>This message was generated by [git-bob](https://github.com/haesleinhuepf/git-bob) (version: {__version__}, model: {model}{link}), an experimental AI-based assistant. It can make mistakes and has [limitations](https://github.com/haesleinhuepf/git-bob?tab=readme-ov-file#limitations). Check its messages carefully.</sup>"
