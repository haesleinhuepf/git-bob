...
def setup_ai_remark():
    """
    Setup the AI remark with the current version of git-bob.

    Returns
    -------
    str
        The AI remark string with the current version of git-bob.
    """
...
def comment_on_issue(repository, issue, prompt_function):
    ...
    prompt_function : function
        The function to generate the comment based on the prompt.
    """
...
def review_pull_request(repository, issue, prompt_function):
    ...
    prompt_function : function
        The function to generate the review comment based on the prompt.
    """
