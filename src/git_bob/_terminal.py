def command_line_interface():
    ...
    remark = "<sup>This comment was generated by [git_bob](https://github.com/haesleinhuepf/git-bob), an AI-based assistant.</sup>"

    if "git_bob comment" in text and remark not in text:
