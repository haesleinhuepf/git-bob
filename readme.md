...
* Recently tested `claude-3-5-sonnet-20240620`, `gpt-4o-2024-08-06`, and `github_models:meta-llama-3.1-405b-instruct` models produce useful results. The model `gemini-1.5-flash-001` is technically supported too, but its results were not very useful. <!-- Add this line -->
